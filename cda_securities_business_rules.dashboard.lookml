- dashboard: cda_securities_business_rules
  title: Securities Business Rules
  layout: grid
  rows:
    - elements: [cda_securities_business_rules_chart]
      height: 300
    - elements: [cda_securities_business_rules]
      height: 700
  embed_style:
  ...
  - name: cda_securities_business_rules_chart
